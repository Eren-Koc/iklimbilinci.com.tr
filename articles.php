...
<meta name="robots" content="index, follow">
  ...
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <title>İklim Bilinci - Makaleler</title>
</head>
<body>
<div class="main">
        <header id="header-id">
...
<div class="article-menu-title-container" id="donate-title">İmza Ver</div>
<a target="_blank" href="https://temizkenguzel.com/#destek-sozu-ver"><button style="background-size: 32px auto; background-image:url(img/cif-logo.png);">Temizken Güzel</button></a>
...
<?php 
$servername = "Your Server Adreess";
...
while($row=mysqli_fetch_array($query_run))
{
       ?>        
           ...
           <div class='article-desc-cont' id='article-desc-$articleid'>
               <p>$articleDesc</p>    
           </div>
           <span class='see-more' id='article-see-more-$articleid' onClick='SeeMore(this.id)'>Devamını Oku...</span>
